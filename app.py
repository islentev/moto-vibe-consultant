...
if st.button("Сгенерировать подбор"):
    with st.spinner('Ищем варианты...'):
        ...
        prompt = f"""
        Ты - эксперт-подборщик по мотоциклам. Клиент: рост {user_height}см, бюджет {budget}р (с учетом, что 60-80к уйдет на экип и подготовку к сезону), 
        ...
        4. Сервис в {city}.
        5. Подходит ли под рост (высота седла vs рост).
        6. Ликвидность: как быстро он его продаст через год.
        7. Технические риски: (твои условия про 2006/2020 года).
        8. Юридический совет: на что смотреть в документах этой конкретной модели в 2026 году.
